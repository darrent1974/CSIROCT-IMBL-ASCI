...
h5_group_xtract = 'exchange'

h5_dataset_xtract_projections = 'exchange/data'
h5_dataset_xtract_flats = 'exchange/data'
h5_dataset_xtract_darks = 'exchange/data'
...
def run_XLICTPreProc( dict_params ):
    return run_xli_cmd( dict_params, cmdXTRACTPreProc )

def run_XLICTWorkflow( dict_params ):
    return run_xli_cmd( dict_params, cmdXTRACTWorkflow )